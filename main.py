# Дорогая компания Стек, я обнаружил неточность у вас на главной странице сайта, в браузере Opera версия: 96.0.4693.50 отображаются % 2 раза во фразе 70%% ПО РЕКОМЕНДАЦИИ клиентов
# Класс Person:
# свойства: ИНН, Адрес
class Person:
